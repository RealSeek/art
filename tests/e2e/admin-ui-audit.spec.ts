...
const routes = [
  ...
  ['enterprise/ai/assets', '文件与资产'], ['enterprise/ai/projects', '项目与工作流'], ['enterprise/ai/inspirations', '灵感内容'],
  ['enterprise/ai/prompt-templates', '提示词模板'], ['enterprise/ai/prompt-library', '提示词库'], ['enterprise/ai/assistants', 'AI 助手'],
  ['enterprise/ai/tools', '工具与审批'], ['enterprise/ai/knowledge-bases', '知识库'], ['enterprise/ai/external-links', '外部入口'],
