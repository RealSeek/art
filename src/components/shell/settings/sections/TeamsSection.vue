...
import { formatInvitationExpiry, formatServerDate } from '../../format'
...
const props = defineProps<{
  ...
  teamLedgerOpenId: string
  teamResources: Record<string, TeamResources | undefined>
  teamCreditLedgers: Record<string, TeamCreditEntry[] | undefined>
  teamQuotaDrafts: Record<string, string>
  ...
  toggleTeamBilling: (team: Team) => Promise<unknown>
  toggleTeamLedger: (teamId: string) => Promise<unknown>
  saveTeamMemberQuota: (team: Team, member: TeamMember) => Promise<unknown>
