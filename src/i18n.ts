...
const zhCN = {
  workspace: { newChat: '新对话', images: '图片', videos: '视频', commerce: '电商中心', office: '办公中心', prompts: '提示词库', plugins: '插件市场', projects: '项目', assets: '文件库', api: 'API', recent: '最近', noChats: '暂无对话', settings: '设置', signIn: '登录', personalization: '个性化', account: '个人资料', logout: '退出登录' },
...
const en = {
  workspace: { newChat: 'New chat', images: 'Images', videos: 'Videos', commerce: 'Commerce studio', office: 'Office center', prompts: 'Prompt library', plugins: 'Plugin market', projects: 'Projects', assets: 'Library', api: 'API', recent: 'Recent', noChats: 'No conversations', settings: 'Settings', signIn: 'Sign in', personalization: 'Personalization', account: 'Profile', logout: 'Sign out' },
...
const zhTW = {
  workspace: { ...zhCN.workspace, newChat: '新對話', images: '圖片生成', videos: '影片生成', commerce: '電商中心', office: '辦公中心', prompts: '提示詞庫', plugins: '外掛市集', projects: '專案', assets: '檔案庫', recent: '最近', noChats: '暫無對話', settings: '設定', signIn: '登入', personalization: '個人化', account: '個人資料', logout: '登出' },
...
const ja = {
  workspace: { newChat: '新しいチャット', images: '画像生成', videos: '動画生成', commerce: 'コマース', office: 'オフィス', prompts: 'プロンプト', plugins: 'プラグイン', projects: 'プロジェクト', assets: 'ライブラリ', api: 'API', recent: '最近', noChats: '会話はありません', settings: '設定', signIn: 'ログイン', personalization: 'パーソナライズ', account: 'プロフィール', logout: 'ログアウト' },
...
const ko = {
  workspace: { newChat: '새 대화', images: '이미지 생성', videos: '동영상 생성', commerce: '커머스', office: '오피스 센터', prompts: '프롬프트', plugins: '플러그인', projects: '프로젝트', assets: '라이브러리', api: 'API', recent: '최근', noChats: '대화 없음', settings: '설정', signIn: '로그인', personalization: '개인화', account: '프로필', logout: '로그아웃' },
