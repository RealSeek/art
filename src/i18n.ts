...
const zhCN = {
  workspace: { newChat: '新对话', creation: 'AI 创作', images: '图片', videos: '视频', commerce: '电商中心', office: '办公中心', prompts: '提示词库', plugins: '插件市场', projects: '项目', assets: '文件库', api: 'API', recent: '最近', noChats: '暂无对话', settings: '设置', signIn: '登录', personalization: '个性化', account: '个人资料', logout: '退出登录' },
