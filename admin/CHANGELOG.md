...
All notable changes to this project will be documented in this file. Contribution rules for the integrated OnlyArt repository are in [CONTRIBUTING](../CONTRIBUTING.md).
